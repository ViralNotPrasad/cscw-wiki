...
write.csv(a, "wiki_english_pageviews_2000_thru_Dec2019.csv")
```
...
write.csv(b, "wiki_hindi_pageviews_2000_thru_Dec2019.csv")
```
...
write.csv(b, "wiki_urdu_pageviews_2000_thru_Dec2019.csv")
```
